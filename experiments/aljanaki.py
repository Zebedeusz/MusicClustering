annotations_path = "/media/michal/HDD1/Music Emotion Datasets/Decoded/data_statistics/aljanaki_simple.csv"
annotations_path_local = "../annotations/aljanaki_1.csv"

# parameters
cluster_sizes = [4, 9, 14, 18]
...
def simplify_annotations_file():
    anns_filepath = "/media/michal/HDD1/Music Emotion Datasets/Decoded/data_statistics/aljanaki_1.csv"
    elements_qnt = 400
